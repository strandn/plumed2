  ...
  if(getStep() == 1) {
    ...
    for(int i = 0; i < 100; ++i) {
      ...
      for(int j = 0; j < 100; ++j) {
        ...
        file << x << " " << y << " " << getBias({ x, y, 0.0, -1.2 }) << std::endl;
      }
    }
    file.close();
    ...
    for(int i = 0; i < 100; ++i) {
      ...
      for(int j = 0; j < 100; ++j) {
        double y = -M_PI + 2 * j * M_PI / 100;
        file << x << " " << y << " " << getBias({ x, y, 0.0, 1.0 }) << std::endl;
      }
    }
    file.close();
    ...
    for(int i = 0; i < 100; ++i) {
      ...
      for(int j = 0; j < 100; ++j) {
        double y = -M_PI + 2 * j * M_PI / 100;
        file << x << " " << y << " " << getBias({ 0.0, x, y, -1.2 }) << std::endl;
      }
    }
    file.close();
    ...
    for(int i = 0; i < 100; ++i) {
      ...
      for(int j = 0; j < 100; ++j) {
        double y = -M_PI + 2 * j * M_PI / 100;
        file << x << " " << y << " " << getBias({ 0.0, x, y, 1.0 }) << std::endl;
      }
    }
    file.close();
    ...
    for(int i = 0; i < 100; ++i) {
      ...
      for(int j = 0; j < 100; ++j) {
        double y = -M_PI + 2 * j * M_PI / 100;
        file << x << " " << y << " " << getBias({ 0.0, -1.2, x, y }) << std::endl;
      }
    }
    file.close();
    ...
    for(int i = 0; i < 100; ++i) {
      ...
      for(int j = 0; j < 100; ++j) {
        double y = -M_PI + 2 * j * M_PI / 100;
        file << x << " " << y << " " << getBias({ 0.0, 1.0, x, y }) << std::endl;
      }
    }
    file.close();
  }
